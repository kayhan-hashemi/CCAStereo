...
parser.add_argument('--test_batch_size', type=int, default=14, help='testing batch size')
parser.add_argument('--epochs', type=int, default=100, help='number of epochs to train')
parser.add_argument('--lrepochs', type=str, default="10,20,40,70:2", help='the epochs to decay lr: the downscale rate')
